...
const CODING_CHALLENGES: CodingChallenge[] = [
  ...
  },
  {
    ...
    description: "Write find_by_artist(playlist, artist) that returns a list of song titles by that artist. Use a list comprehension. Each song is a dict with 'title', 'artist', and 'duration' keys.",
    example: "# Each song looks like:\n{'title': 'Levitating', 'artist': 'Dua Lipa', 'duration': 203}\n\nfind_by_artist(songs, 'Dua Lipa')\n→  ['Levitating']",
